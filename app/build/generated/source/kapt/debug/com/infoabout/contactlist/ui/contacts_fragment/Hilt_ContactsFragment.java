...
public abstract class Hilt_ContactsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ContactsFragment() {
    super();
  }

  Hilt_ContactsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ContactsFragment_GeneratedInjector) this.generatedComponent()).injectContactsFragment(UnsafeCasts.<ContactsFragment>unsafeCast(this));
    }
  }
