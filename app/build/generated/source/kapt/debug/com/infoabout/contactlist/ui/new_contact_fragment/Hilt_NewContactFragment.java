...
public abstract class Hilt_NewContactFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NewContactFragment() {
    super();
  }

  Hilt_NewContactFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NewContactFragment_GeneratedInjector) this.generatedComponent()).injectNewContactFragment(UnsafeCasts.<NewContactFragment>unsafeCast(this));
    }
  }
