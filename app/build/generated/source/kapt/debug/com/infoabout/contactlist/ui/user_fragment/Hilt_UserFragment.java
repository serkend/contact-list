...
public abstract class Hilt_UserFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_UserFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UserFragment_GeneratedInjector) this.generatedComponent()).injectUserFragment(UnsafeCasts.<UserFragment>unsafeCast(this));
    }
  }
