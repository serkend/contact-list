...
public abstract class Hilt_FavoriteContactsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FavoriteContactsFragment() {
    super();
  }

  Hilt_FavoriteContactsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FavoriteContactsFragment_GeneratedInjector) this.generatedComponent()).injectFavoriteContactsFragment(UnsafeCasts.<FavoriteContactsFragment>unsafeCast(this));
    }
  }
